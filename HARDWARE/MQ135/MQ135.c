...
void MQ135_Init(void)
{
	GPIO_InitTypeDef GPIO_InitStructure;
 	...
 	RCC_APB2PeriphClockCmd(MQ135_GPIO_CLK,ENABLE);//使能PORTA
	GPIO_InitStructure.GPIO_Pin  = MQ135_GPIO_Pin;
	GPIO_InitStructure.GPIO_Mode = MQ135_GPIO_Mode; //设置成上拉输入
